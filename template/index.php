...
<head>
    <meta charset="UTF-8">
    <title>MP3音乐搜索器 - 多站合一音乐搜索,音乐在线试听</title>
...
<body>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href=" " target="_blank" rel="author">联系我们</a>&nbsp;<a href="https://github.com/maicong/music/issues" target="_blank">意见反馈</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
